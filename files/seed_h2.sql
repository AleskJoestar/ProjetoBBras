-- ============================================================
--  SEED H2 — dados de teste
--  Execute após schema_h2.sql (já rodado automaticamente pelo Conectar.java)
--  Login: CPF=00000000000 / senha=admin123
-- ============================================================

INSERT INTO funcionario
    (nome_fun, cpf_fun, rg_fun, endereco_fun, telefone_fun, email_fun, funcao_fun, departamento_fun, senha_fun)
VALUES
    ('Administrador', '00000000000', '0000000', 'Rua Teste, 1',      '(69)99999-0001', 'admin@empresa.com', 'Gerente',  'Diretoria', 'admin123'),
    ('João Vendedor',  '11122233344', '1112223', 'Rua das Flores, 10','(69)99999-0002', 'joao@empresa.com',  'Vendedor', 'Vendas',    'senha123');
